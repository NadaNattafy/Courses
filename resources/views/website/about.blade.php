    ...
    <div class="st-pusher">
        ...
        <nav class="st-menu st-effect-8" id="menu-8">
            ...
            <ul>
                ...
                <li><a class="icon icon-study" href="{{route('website.addcourses.index')}}"><i class="fa fa-plus"></i> اضافة دورة</a></li>
                <li><a class="icon icon-photo" href="{{route('website.addlectures.index')}}"><i class="fa fa-plus"></i>اضافة محاضرة</a></li>
                <li><a class="icon icon-wallet" href="{{route('website.addtests.index')}}"><i class="fa fa-plus"></i>اضافة اختبار</a></li>
                <li><a class="icon icon-data" href="{{route('website.allcourses.index')}}"><i class="fa fa-database"></i>جميع الدورات</a></li>
                <li><a class="icon icon-location" href="{{route('website.category.index')}}"><i class="fa fa-rocket"></i>قسم معين</a></li>
                ...
                <li><a class="icon icon-location" href="{{route('website.courses.index')}}"><i class="fa fa-rocket"></i>درس معين</a></li>
