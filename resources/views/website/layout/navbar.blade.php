...
<nav class="st-menu st-effect-8" id="menu-8">
    ...
    <ul>
        ...
        <li><a class="icon icon-data" href="#"><i class="fa fa-database"></i>جميع الدورات</a></li>
        ...
        <li><a class="icon icon-wallet" href="#"><i class="fa fa-alerts"></i>التنبيهات</a></li>
        <li><a class="icon icon-data" href="#"><i class="fa fa-comments"></i>التعليقات</a></li>
