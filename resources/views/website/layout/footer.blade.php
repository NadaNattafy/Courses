    ...
    <div class="container">
        ...
        <div class="footer-links col-md-2 col-xs-12 pull-left text-center">
            <ul>
                ...
                <li>
                    <a href="https://www.twitter.com" data-toggle="tooltip" data-placement="top" title="twitter">
                        <i class="fa fa-twitter-square"></i>
                    </a>
                </li>

                <li>
                    <a href="https://www.linkedin.com" data-toggle="tooltip" data-placement="top" title="linkedin">
