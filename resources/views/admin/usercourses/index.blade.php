                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{-- <a class="btn btn-info" href="{{ route('admin.usercourses.show',$usercourse->id) }}">Show</a>
                                    <a class="btn btn-primary" href="{{ route('admin.usercourses.edit',$usercourse->id) }}">Edit</a> --}}
                                    <form action="{{ route('admin.usercourses.destroy',$usercourse->id) }}" method="POST">
