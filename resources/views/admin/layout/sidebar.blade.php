            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li><a href="{{route('admin.admins.index')}}">Index Admin</a></li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li><a href="{{route('admin.trainers.index')}}">Index Trainers</a></li>
                        <li><a href="{{route('admin.trainers.create')}}">Create Trainers</a></li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li><a href="{{route('admin.courses.index')}}">Index Course</a></li>
